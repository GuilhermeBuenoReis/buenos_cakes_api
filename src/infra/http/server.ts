...
import { env } from './env';
import { addOrderItemRoute } from './routes/add-order-item-route';
...
import { removeOrderItemRoute } from './routes/remove-order-item-route';
...
import { updateOrderItemOnOrderRoute } from './routes/update-order-item-on-order-route';
...
app.register(addOrderItemRoute);
app.register(updateOrderItemOnOrderRoute);
app.register(removeOrderItemRoute);
