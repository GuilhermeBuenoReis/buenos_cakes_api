...
import { ListProductsByCategoryService } from '@/domain/products/application/services/list-products-by-category-service';
...
export const listProductsByCategoryRoute: FastifyPluginAsyncZod = async (
  app
) => {
  app.get(
